...
# voxel_size = [0.15, 0.15, 0.5]  # 3 levels
dbound=[1.0, 35.0, 0.5]
origin=[0., 0., 8.5]
# origin=[0., 0., 0.]
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            encoder=dict(
                type='FastBEV',
                style="v4",
                neck_fuse=dict(in_channels=[768, 512, 256], out_channels=[256, 256, 256]),
                neck_3d=dict(
                    type='M2BevNeck',
                    in_channels=256,
                    out_channels=256,
                    ...
                    stride=2,
                    is_transpose=False,
                    fuse=dict(in_channels=256 * 1 * 1 * 3, out_channels=256),  # c*seq*h*fpn_lvl
