...
point_cloud_range = [-15.0, -30.0, -2.2, 15.0, 30.0, -0.8]
# voxel_size = [0.15, 0.15, 20.0]
voxel_size = [0.15, 0.15, 0.2]  # 7 levels
dbound=[1.0, 35.0, 0.5]
origin=[0.075, 0.075, -1.4]
# origin=[0., 0., 0.]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_seg=dict(type='SimpleLoss', 
            pos_weight=4.0,
            loss_weight=3.0),  # modified by guoqi, origin 1.0
...
checkpoint_config = dict(max_keep_ckpts=12, interval=2)
